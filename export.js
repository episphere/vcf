...
*/
async function Vcf(url='https://ftp.ncbi.nih.gov/snp/organisms/human_9606/VCF/All_20180418.vcf.gz', keyGap=vcf.keyGap, chrCode=vcf.chrCode){
...
vcf.batchQuery= async function(query,that){
    ...
    if(filtered.length > 0){
        ...
        alert('There are no valid positions in the input')
        return compiled
    }
